...
export const assignmentFormSchema = z.object({
  ...
  skills_justification: z.string().nullable().transform(val => val ?? "").optional().default(""),
  pride_reason: z.string().nullable().transform(val => val ?? "").optional().default(""),
  creation_process: z.string().nullable().transform(val => val ?? "").optional().default(""),
  learnings: z.string().nullable().transform(val => val ?? "").optional().default(""),
  challenges: z.string().nullable().transform(val => val ?? "").optional().default(""),
  improvements: z.string().nullable().transform(val => val ?? "").optional().default(""),
  acknowledgments: z.string().nullable().transform(val => val ?? "").optional().default(""),
